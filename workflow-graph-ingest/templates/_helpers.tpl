...
*/}}
{{- define "workflow-graph-ingest.name" -}}
...
*/}}
{{- define "workflow-graph-ingest.fullname" -}}
...
*/}}
{{- define "workflow-graph-ingest.chart" -}}
...
*/}}
{{- define "workflow-graph-ingest.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "workflow-graph-ingest.fullname" .) .Values.serviceAccount.name }}
{{- else }}
